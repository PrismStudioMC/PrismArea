...
final class BlockActorInvMenuGraphic implements PositionedInvMenuGraphic
{
    ...
    private readonly BlockInvMenuGraphic $block_graphic;
    private readonly Vector3 $position;
    private readonly CompoundTag $tile;
    private readonly ?InvMenuGraphicNetworkTranslator $network_translator;
    private readonly int $animation_duration;
